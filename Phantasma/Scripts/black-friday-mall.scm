...
;;;============================================================================
;;; TERRAIN PALETTE
;;; Maps single-character glyphs to terrain types
;;; Signature: (kern-mk-palette tag ((glyph1 terrain1) (glyph2 terrain2) ...))
;;;============================================================================

(kern-print "Creating terrain palette...")

(define pal-mall
  (kern-mk-palette 'pal-mall
    '(("." t-grass)      ; Grass
       ("t" t-tree)       ; Trees
       ("~" t-water)      ; Water
       ("^" t-mountain)   ; Mountains/walls
       ("f" t-floor)      ; Floor
       ("#" t-wall))))    ; Wall

(kern-print "  ✓ Palette created")

;;;============================================================================
;;; TERRAIN MAP
;;; Creates the actual map layout using the palette
;;; Signature: (kern-mk-map tag width height palette (line1 line2 line3 ...))
;;;============================================================================

(kern-print "Creating terrain map...")

;; 64x64 map with single-character glyphs
;; Legend: . = grass, ^ = mountain/wall, f = floor, t = tree, ~ = water
(define map-mall
  (kern-mk-map 'map-mall 64 64 pal-mall
    '(
       ;; Row 0
       "t t t t . . . . . . . . . . . . . . . . . . . . . . . . ^ ^ ^ ^ ^ . ^ ^ ^ . . . . . . . . . . . . . . . . . . . . . . . . . t t t t"
       ;; Row 1
       ...
       ". . . . . . . . . . ^ f # f f f f f f f # f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f ^"
       ". . . . . . . . . . ^ f # f f f f f f f # f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f ^"
       ;; Row 42 - Mystique's shop south wall with door
       ...
       ". . . . . . . . . . ^ f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f ^"
       ". . . . . . . . . . ^ f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f f ^"
       ;; Row 50 - Mall south wall with entrance
       ". . . . . . . . . . ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ f f f f f ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^ ^"
       ;; Row 51
       ". . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . ."
       ;; Row 52
...
(define mall
  (kern-mk-place
    'mall                     ; tag
    "The Grand Mall of Olde"  ; name
    nil                       ; sprite (no special place sprite)
    map-mall                  ; terrain-map (REQUIRED!)
    #f                        ; wraps (doesn't wrap at edges)
    #f                        ; underground (not underground)
    #f                        ; wild (not wilderness)
    #t                        ; combat (combat enabled)
    '()                       ; subplaces (no sub-regions)
    '()                       ; neighbors (no neighboring places)
    '()                       ; contents (objects added separately)
    '()                       ; hooks (no special effects)
    '()))                     ; entrances (no special entrances)
